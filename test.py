...
class CFunctionParser:
    ...
    def generate_yaml_output(self):
        ...
        for func in self.all_functions: 
            ...
            keywords = [ "parse", "handle", "read","search","recv","send"]
            keyfunction = ["readrecv_message", "read", "ock_recvmsg"]
            if( (any(keyword in func['name'] for keyword in keywords) or any(keyfunction in func['full_function'] for keyfunction in keyfunction)) and val >= 1.5*a):
                print(func['name'], val)
